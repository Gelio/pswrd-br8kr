...
const OPTION_DEFINITIONS = [
  ...
  { name: 'pass-file', alias: 'f', type: String, description: 'Path to a file with passwords' },
  { name: 'pass-prefix', alias: 'p', type: String, defaultValue: DEFAULT_OPTIONS.passPrefix, description: 'Password prefix' },
